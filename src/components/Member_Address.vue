      ...
      <div class="m_content">
        ...
        <div class="m_right">
          ...
          <table border="0" class="add_tab" style="width:930px;"  cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td align="right">详细地址</td>
              <td style="font-family:'宋体';"><input type="text" id="address" value="" class="add_ipt" />（必填）</td>
    ...
    export default {
        ...
        methods: {
            cy:function (event) {
                ...
                axios.post('http://localhost/blog/public/api/auth/member_address',{
                    p_id:p_id,
            ...
            add(){
                ...
                var address=aa+"省"+bb+"市"+cc+"(县)"+address
