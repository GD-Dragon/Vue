  ...
  <div>
    ...
    <div class="i_bg">
      <div class="content mar_20">
        &nbsp;<router-link to="/Buycart_Two"> <img src="../assets/images/img1.jpg" /></router-link>
      </div>
      ...
      <div class="content mar_20">
        ...
        <table border="0" class="car_tab" style="width:1200px;  align:center" cellspacing="0" cellpadding="0" >
          ...
          <tr v-for="(value,key) in cart"  align="center" >
            <td><input type="checkbox" class="input" v-bind:value="value.product_id" v-on:click="checkboxa(value)" name="side"></td>
            <td align="center">
              <div class="c_s_img"><img src="../assets/images/c_1.jpg" width="73" height="73" /></div>
              <div align="center" >{{value.name}}</div>
            </td>
            <td align="center">{{value.goods_attr_name}}</td>
            <td align="center">
              <div class="c_num" >
                <input type="button" v-on:click="greed(value.num -=1,value.product_id)" class="car_btn_1" value="-">
                <!--              当点击时并且传参，当点减得时候减1-->
          ...
          <tr valign="top" height="150">
            <td colspan="6" align="right">
              <a href="#"><img src="../assets/images/buy1.gif" /></a>&nbsp; &nbsp; <span v-on:click="order()"><img src="../assets/images/buy2.gif" /></span>
            </td>
          </tr>
        </table>
      </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            greed (res,product_id){
                axios.post(this.url+'/auth/buy',{
                    num:res,
